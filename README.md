...
[comment]: <> ([![Build Status]&#40;https://travis-ci.com/CN-pangliang/My-RPC-Framework.svg?branch=master&#41;]&#40;https://travis-ci.com/CN-pangliang/My-RPC-Framework&#41;)

[comment]: <> (![GitHub]&#40;https://img.shields.io/github/license/CN-pangliang/My-RPC-Framework&#41;)
...
public class NettyTestClient {
    ...
    public static void main(String[] args) {
        ...
        String res = helloService.hello("pangliang");
...
首先启动服务提供者，再启动消费者，在消费侧会输出`Hello, pangliang`。
...
My-RPC-Framework is under the MIT license. See the [LICENSE](https://github.com/CN-pangliang/My-RPC-Framework/blob/master/LICENSE) file for details.
